...
task :post do
  ...
  open(filename, 'w') do |post|
    ...
    post.puts "本文目录"
    post.puts " "
    post.puts "1.  <a href=\"#t1\">title1</a>"
    post.puts " "
    post.puts "2.  <a href=\"#t2\">title2</a>"
    post.puts " "
    post.puts "3.  <a href=\"#t3\">title3</a>"
    post.puts " "
    post.puts "---"
    post.puts "## <a name=\"t1\"></a>title1"
    post.puts " "
    post.puts "## <a name=\"t2\"></a>title2"
    post.puts " "
    post.puts "## <a name=\"t3\"></a>title3"
    post.puts " "
    post.puts "<div align=\"right\"><a href=\"#t\">返回目录</a></div>"
  end
end # task :post
