...
---
{% include JB/setup %}
_文/<a href="http://www.yangzhiping.com" style="color:grey">阳志平</a>_	
这篇文章总结了针对大多数科学网上已有的一些开放资源，这是不受你所在学校 IP 限制的一些网页，以及如何配合各种软件来整理这些资源，思路很清晰，值得借鉴。只是里面有些链接，对于具体专业领域可能不是那么使用，所以读者在阅读的时候最好能<!-- more -->有所取舍。以下摘自[阳志平的博客](http://www.yangzhiping.com)
